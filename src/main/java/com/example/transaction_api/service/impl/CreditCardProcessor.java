...
public class CreditCardProcessor implements PaymentProcessor {
    ...
    public Transaction  processPayment(TransactionRequest request, User user) {
        log.info("Processing credit card payment of ${}", request.getAmount());
        ...
        return Transaction.builder()
                ...
                .category(TransactionCategory.valueOf(request.getCategory()))
    ...
    public PaymentMethod getPaymentMethod() {
        log.info("Getting payment method for Credit Card Processor");
        return PaymentMethod.CREDIT_CARD;
    }

    @Override
    public boolean validatePaymentDetails(TransactionRequest request) {
        log.info("Validating credit card payment details for user {}", request.getUserId());
    ...
    public String getProcessorName() {
        log.info("Using Credit Card Processor for Visa/MasterCard transactions");
        return "Credit Card Processor (Visa/MasterCard)";
    }
